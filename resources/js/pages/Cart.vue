        ...
        <div class="container-fluid">
            ...
            >
                ...
                <div class="buttons mt-4">
                    <router-link class="btn btn-danger" :to="{ name: 'home' }"
                        >BACK</router-link
                    >
                    <router-link
                        class="checkout btn .blue-background"
                        :to="{ name: 'checkout' }"
            ...
            <div
                class="cart-item p-2 border w-25"
                v-for="(item, index) in itemQuantities"
                :key="index"
            >
                ...
                <p class="cart-item-item">
                    Price: {{ item.price * item.quantity }}$
                </p>
            </div>
            <div class="right-content">
                <button class="btn mt-4" @click="emptyCart()">
                    Empty cart
                </button>
            </div>
        </div>
...
export default {
    ...
    computed: {
        ...
        totalAmount() {
            const amount = Object.values(this.itemQuantities).reduce(
                (accumulator, item) => {
